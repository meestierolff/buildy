...
import { resolveDefaultMediaWorker } from "./runtime.js";
...
export function createMediaCronHandler(
  resolveWorker = resolveDefaultMediaWorker,
) {
  return async function handleMediaCronRequest(request: Request, requestId: string): Promise<Response> {
...
export const handleDefaultMediaCronRequest = createMediaCronHandler();
