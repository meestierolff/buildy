...
export default function ProjectSettingsSheet({
  ...
  const saveDates = async () => {
    ...
    toast.success("Looptijd opgeslagen");
    onChanged();
  };
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="w-full sm:max-w-md overflow-y-auto">
        ...
        <div className="mt-6 space-y-6">
          {/* Beschrijving */}
          <div className="space-y-3">
            <h3 className="text-sm font-semibold">Beschrijving</h3>
            <Textarea
              value={descDraft}
              onChange={(e) => setDescDraft(e.target.value)}
              rows={3}
          ...
          {/* Looptijd */}
          <div className="space-y-3">
            <h3 className="text-sm font-semibold">Looptijd</h3>
            <div className="space-y-2">
              <Label htmlFor="settings-start-date" className="text-xs text-muted-foreground">
                Startdatum
              </Label>
              <Input
            ...
            <div className="space-y-2">
              <Label htmlFor="settings-end-date" className="text-xs text-muted-foreground">
                Geplande einddatum
              </Label>
              <Input
