...
const Footer = () => (
  <footer className="mt-12 border-t border-border bg-card/40">
    <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-6 px-6 pb-24 pt-9 text-xs text-muted-foreground md:flex-row md:items-center md:px-8 md:py-9">
      <div className="flex items-center gap-3">
        <BrandLogo href="/" imageClassName="h-8 w-8 rounded-lg" textClassName="text-base" />
        <p className="border-l border-border pl-3 leading-relaxed">
          © {new Date().getFullYear()}<br className="sm:hidden" /> Van verbouwing naar Bouwboek.
        </p>
      </div>
      <nav className="flex flex-wrap items-center gap-x-5 gap-y-3" aria-label="Footer navigatie">
        <a
