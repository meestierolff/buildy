...
// Authentication tables are reachable only through the same-origin server
// runtime. Every remaining public table fails closed through PostgreSQL RLS.
const SERVER_AUTH_CORE_TABLES = new Set([
  "auth_accounts",
  "auth_rate_limits",
  "auth_sessions",
  "auth_users",
...
export const EXPECTED_RLS_TABLES = EXPECTED_PUBLIC_TABLES.filter(
  (table) => !SERVER_AUTH_CORE_TABLES.has(table),
);
...
const REQUIRED_FUNCTIONS = [
  ...
  "app_redact_request_hashes_on_account_erasure",
  "app_redact_request_hashes_on_project_erasure",
  "app_project_worker_finalize_deletion",
  "app_actor_id",
  "app_suppress_retired_provider_outbox_event",
  "app_ack_outbox_event",
  "app_begin_media_processing_job",
  "app_claim_media_processing_asset",
  "app_claim_outbox_event",
  "app_fail_media_processing_job",
  "app_finalize_media_processing_job",
  "app_media_protected_object_keys",
  "app_media_worker_claim_orphan_cleanup",
  "app_media_worker_finalize_orphan_cleanup",
  "app_media_worker_fail_orphan_cleanup",
  "app_photobook_worker_claim",
  "app_photobook_worker_claim_revision",
  ...
  "app_can_view_update",
  "app_share_link_id",
  "app_issue_project_share_link",
  "app_revoke_project_share_link",
  "app_redeem_project_share_link",
  "invalidate_project_share_links_from_project",
  "invalidate_project_share_links_from_account",
  "app_can_manage_comment",
  "app_can_view_notification_target",
  "app_enqueue_first_update_publication_notifications",
  "app_enqueue_photobook_order_event_notification",
  "app_enqueue_engagement_notification",
  "app_enqueue_social_notification",
  "app_follow_state_allowed",
  "app_lock_social_user_pair",
  "app_list_profile_connections",
  "app_search_profile_identities",
  "app_owns_project",
  ...
  "guard_feedback_submission_account_erasure",
  ...
  "guard_manual_photobook_fulfilment",
...
const REQUIRED_TRIGGERS = [
  ...
  "feedback_submission_reviews_append_only",
  "feedback_submissions_guard_account_erasure",
  "media_assets_guard_locked_proof",
  "media_assets_guard_linked_avatar",
  "notifications_guard_recipient_update",
  "outbox_events_suppress_retired_provider_automation",
  "photobook_order_events_append_only",
  "photobook_orders_guard_transition",
  "photobook_orders_guard_manual_fulfilment",
  ...
  "app_users_redact_request_hashes_on_erasure",
  "projects_redact_request_hashes_on_erasure",
  "project_share_links_set_updated_at",
  "projects_invalidate_share_links",
  "app_users_invalidate_project_share_links",
  "updates_enqueue_first_publication_notifications",
  "photobook_order_events_enqueue_product_notification",
