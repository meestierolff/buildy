...
- Last fully green automatic candidate: `2446b8bb558534c1fc297e8eae653bfe6775f392`.
  [CI 34212610708](https://github.com/meestierolff/buildy/actions/runs/34212610708):
...
| Tested deployment | `dpl_3f7gjAGFNikxDA8KxHNSKJnBfTco`, exact source `2446b8bb558534c1fc297e8eae653bfe6775f392`, READY. [Stable Preview](https://buildy-git-release-free-mvp-20260908-clarios-projects-05f6a57e.vercel.app) |
...
| F3–F4 | Owner link creation and anonymous viewer/photo reads without edit/book access PASS on `2446b8b`. A second real account registered normally. Its shared project is then covered by the owner's global onboarding modal; F4 stops before reaction/comment. Viewer account and share grant retained for the corrected route check |
...
SDK error classification, update timestamp normalization and onboarding route scope.
...
Deploy the reviewed onboarding route correction and resume with the existing
fresh viewer on the shared project, then complete the remaining journey. Finish required CI on
...
Verdict: **hosted accounts, three persisted photos, edit/relogin and anonymous sharing
work; fresh-viewer route fix verified locally; full social/book/deletion journey
