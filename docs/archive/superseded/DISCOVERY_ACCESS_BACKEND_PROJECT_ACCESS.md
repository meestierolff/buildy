...
> **SUPERSEDED.** Direct project-follow/project-access is retired. Gebruik
> [`SOCIAL_STATE_MACHINE.md`](../../SOCIAL_STATE_MACHINE.md) voor canonical
> profiel-follow en de vier Verbouwingvisibilities.
