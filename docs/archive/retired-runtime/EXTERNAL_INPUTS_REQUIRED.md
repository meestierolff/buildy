...
> **ARCHIEF — NIET ALS LAUNCHCHECKLIST GEBRUIKEN.** Dit is de historische
> R2/Brevo/geautomatiseerde-Peecho providerinventaris. De actuele externe gates
> staan in [`OPERATOR_ACTIONS_REQUIRED.md`](../../OPERATOR_ACTIONS_REQUIRED.md);
> Buildy gebruikt nu private Vercel Blob, Stripe Checkout, handmatige
> printfulfilment en geen e-mailprovider.
