...
> **ARCHIEF — GEEN ACTIEVE REGISTRATIE-INSTRUCTIE.** Deze versie beschrijft
> e-mail/magic-link en Better Auth. Gebruik de actuele
> [`PRIVATE_BETA.md`](../../PRIVATE_BETA.md), die Google-only is.
