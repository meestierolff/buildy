...
> **ARCHIEF — GEEN ACTIEVE RUNTIME-INSTRUCTIE.** Dit document bewaart het
> vroegere ontwerp zonder beheerqueue en met Brevo/outbox-receipts. Gebruik de
> actuele [`MODERATION_SUPPORT_FEEDBACK.md`](../../MODERATION_SUPPORT_FEEDBACK.md):
> server-side RBAC is actief en er is geen e-mailprovider.
