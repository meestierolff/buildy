...
> **ARCHIEF — NIET UITVOEREN.** Dit document bewaart het historische
> Better Auth/R2/Brevo/Peecho-cutoverontwerp en de toenmalige veiligheidsclaims.
> Die provider- en runtimerichting is vervangen door Google OIDC, private Vercel
> Blob, Stripe Checkout, handmatige printfulfilment en geen e-mailprovider. Zie
> [`PRODUCTION_RELEASE.md`](../../PRODUCTION_RELEASE.md) voor de actieve procedure.
