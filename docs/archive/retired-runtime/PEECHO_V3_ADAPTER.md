...
> **ARCHIEF — NIET UITVOEREN.** De beschreven adapter, callbacks, workers en
> operatorscripts zijn uit de actieve runtime verwijderd. Er zijn geen
> `PEECHO_*`-variabelen of automatische providercalls. Gebruik uitsluitend de
> huidige handmatige procedure in
